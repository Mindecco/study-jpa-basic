...
public class JpaMain {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            Member member1 = em.find(Member.class, 1000); // select 쿼리가 안나간다. Why? DB조회가 아닌, 영속성컨텍스트 1차캐시에 이미 존재하기 때문에, find 해서 return
            Member member2 = em.find(Member.class, 1000);
